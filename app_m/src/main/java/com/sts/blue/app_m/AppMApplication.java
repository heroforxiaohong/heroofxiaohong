...
import com.sts.blue.app_m.server.ServerChannelInitializer;
import com.sts.blue.app_m.server.TCPServer;
...
//        SpringApplication.run(AppMApplication.class, args);
        ConfigurableApplicationContext context = SpringApplication.run(AppMApplication.class, args);
